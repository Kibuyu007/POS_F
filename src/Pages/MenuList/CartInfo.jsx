...
import { removeItems, increaseQuantity } from "../../Redux/cartSlice";
...
const CartInfo = () => {
  ...
  return (
    <div className="px-4 py-2 top-2">
      <h1 className="text-lg text-black font-semibold tracking-wide">Order Details</h1>
      ...
      <div className="mt-4 overflow-y-scroll scrollbar-hide h-[420px]" ref={scrolling}>
        {cartData.length === 0 ? (
          <p className="text-black flex justify-center items-center h-[380px]">
            <span className="bg-GreenText rounded-md py-3 px-4">Empty Order</span>
          </p>
        ) : (
          cartData.map((items) => (
            <div key={items.id} className="bg-[#d6d6d6] rounded-lg px-4 py-4 mb-2">
              <div className="flex items-center justify-between">
                <h1 className="text-black font-bold tracking-wide text-xl">{items.name}</h1>
